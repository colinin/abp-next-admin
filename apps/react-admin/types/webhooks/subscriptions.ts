import type { CreationAuditedEntityDto, IHasConcurrencyStamp, PagedAndSortedResultRequestDto } from "#/abp-core";

interface WebhookSubscriptionDto extends CreationAuditedEntityDto<string>, IHasConcurrencyStamp {
	description?: string;
...
interface WebhookSubscriptionUpdateDto extends IHasConcurrencyStamp, WebhookSubscriptionCreateOrUpdateDto {}

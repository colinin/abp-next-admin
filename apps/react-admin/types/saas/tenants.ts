...
interface TenantDto extends ExtensibleAuditedEntityDto<string>, IHasConcurrencyStamp {
	/** 禁用时间 */
	disableTime?: string;
	/** 版本Id */
	editionId?: string;
...
interface TenantUpdateDto extends IHasConcurrencyStamp, TenantCreateOrUpdateBase {}

...
interface UserFavoriteMenuUpdateDto extends IHasConcurrencyStamp, UserFavoriteMenuCreateOrUpdateDto {}

export type { UserFavoriteMenuCreateDto, UserFavoriteMenuDto, UserFavoriteMenuUpdateDto };

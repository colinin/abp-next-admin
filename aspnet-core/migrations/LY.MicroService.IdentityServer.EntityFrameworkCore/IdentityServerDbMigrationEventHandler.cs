...
public class IdentityServerDbMigrationEventHandler : EfCoreDatabaseMigrationEventHandlerBase<IdentityServerMigrationsDbContext>
{
    ...
    public IdentityServerDbMigrationEventHandler(

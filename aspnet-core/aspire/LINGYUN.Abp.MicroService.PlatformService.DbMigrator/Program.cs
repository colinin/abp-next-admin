...
#if DEBUG
        .MinimumLevel.Override("LINGYUN.Abp.MicroService.PlatformService", LogEventLevel.Debug)
#else
        .MinimumLevel.Override("LINGYUN.Abp.MicroService.PlatformService", LogEventLevel.Information)
#endif
...
try
{
    var builder = Host.CreateDefaultBuilder(args)
        ...
        {
            services.AddHostedService<PlatformServiceDbMigratorHostedService>();
        });

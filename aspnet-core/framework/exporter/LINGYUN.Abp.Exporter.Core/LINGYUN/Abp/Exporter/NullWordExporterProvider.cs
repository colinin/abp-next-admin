...
public class NullWordExporterProvider : IWordExporterProvider, ISingletonDependency
{
    ...
    public Task<Stream> ExportAsync(byte[] template, object data, CancellationToken cancellationToken = default)
    {
        return Task.FromResult(_nullStreamCache);
    }
}

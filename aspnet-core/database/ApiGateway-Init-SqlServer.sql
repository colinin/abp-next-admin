...
-- ----------------------------
IF EXISTS (SELECT * FROM sys.all_objects WHERE object_id = OBJECT_ID(N'[apigateway].[api.gateway.published]') AND type IN ('U'))
	DROP TABLE [apigateway].[api.gateway.published]
GO

CREATE TABLE [apigateway].[api.gateway.published] (
  [Id] bigint NOT NULL,
...
-- ----------------------------
IF EXISTS (SELECT * FROM sys.all_objects WHERE object_id = OBJECT_ID(N'[apigateway].[api.gateway.received]') AND type IN ('U'))
	DROP TABLE [apigateway].[api.gateway.received]
GO

CREATE TABLE [apigateway].[api.gateway.received] (
  [Id] bigint NOT NULL,
  [Version] nvarchar(20) NULL,
...
INSERT INTO [apigateway].[appapigatewaydiscovery] VALUES (N'1', N'1260841964962947072', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL), (N'2', N'1364484859756847104', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL), (N'3', N'1371652231699025920', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL), (N'4', N'1376862654239059968', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL), (N'5', N'1393502847586988032', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL), (N'6', N'1416295790013263872', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL), (N'7', N'1417661085990727680', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL)
GO
...
INSERT INTO [apigateway].[appapigatewayratelimitoptions] VALUES (N'1', N'1260841964962947072', N'ClientId', N'{
  "error": {
    "code": "429",
...
-- ----------------------------
-- Indexes structure for table api.gateway.published
-- ----------------------------
CREATE NONCLUSTERED INDEX [IX_ExpiresAt]
ON [apigateway].[api.gateway.published] (
  [ExpiresAt]
)
GO
...
-- ----------------------------
-- Primary Key structure for table api.gateway.published
-- ----------------------------
ALTER TABLE [apigateway].[api.gateway.published] ADD PRIMARY KEY CLUSTERED ([Id])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)
GO


-- ----------------------------
-- Indexes structure for table api.gateway.received
-- ----------------------------
CREATE NONCLUSTERED INDEX [IX_ExpiresAt]
ON [apigateway].[api.gateway.received] (
  [ExpiresAt]
)
GO
...
-- ----------------------------
-- Primary Key structure for table api.gateway.received
-- ----------------------------
ALTER TABLE [apigateway].[api.gateway.received] ADD PRIMARY KEY CLUSTERED ([Id])
WITH (PAD_INDEX = OFF, STATISTICS_NORECOMPUTE = OFF, IGNORE_DUP_KEY = OFF, ALLOW_ROW_LOCKS = ON, ALLOW_PAGE_LOCKS = ON)
GO
